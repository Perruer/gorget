"""
In this example, we demonstrate how to use Gorget in the fastest and least disruptive way possible.
...
# pip install gorget@git+https://github.com/Perruer/gorget.git
