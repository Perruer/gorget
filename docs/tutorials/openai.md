...
This example demonstrates how to use Gorget as a firewall of OpenAI client.

## Simple example

In [openai_api.py](https://github.com/Perruer/gorget/blob/main/examples/openai_api.py), Gorget is used to protect OpenAI ChatGPT client.
...
In [openai_streaming.py](https://github.com/Perruer/gorget/blob/main/examples/openai_streaming.py), Gorget is used to protect OpenAI ChatGPT client with streaming.
